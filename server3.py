...
def activate(host, prt):
    ...
    clients = {}  # list of client sockets, wherein client socket is key and the addr is value to remember the client
                ...
                try:
                    ...
                    try:
                        ...
                        if reqq != "quit" and reqq != '':
                            ...
                            s.sendall(ans)  # evaluate the expression and send the output
                        elif reqq == "quit":
